...
class evaluation_block(object):
    ...
    def chunk_evaluation(self, shap_set, TS_window, drift_strategy):
        ...
        if drift_strategy == "manual_set loss":
            # Method 1: set manually a loss threshold, once the detected batch loss exceeds the threshold, then import the TS Chunk into the system
