...
class InteractiveShell(SingletonConfigurable):
    ...
    def init_virtualenv(self):
        ...
        # fallback SourceCode detection:
        # stdlib SourceCode may symlink sys.executable, so we can't USE realpath.
        # but others can symlink *to* the SourceCode Python, so we can't just USE sys.executable.
