...
df_file_train = pd.read_csv("/Users/Jingwei/PycharmProjects/distributed_use/venv/TestDataset/UCR_TS_Archive_2015/Trace/Trace_TRAIN",header=None)
df_file_test = pd.read_csv("/Users/Jingwei/PycharmProjects/distributed_use/venv/TestDataset/UCR_TS_Archive_2015/Trace/Trace_TEST",header=None)
...
df_noised = add_noise_random_position(df_file_test, 0.05, 0.2, 10)

elemt1, elemt2 = df_partition(df_noised)
df_list_origin, df_list = concept_construct(elemt1, elemt2, 3)

folder_ConceptDriftFile = "/Users/Jingwei/Desktop/ISMAP_results/concept_drift_files/Trace"
